...
enum pragma_omp_clause {
  ...
  PRAGMA_OMP_CLAUSE_TASK_NAME,
  PRAGMA_OMP_CLAUSE_TASK_REDUCTION,
  PRAGMA_OMP_CLAUSE_TASKGROUP,
  PRAGMA_OMP_CLAUSE_THREAD_LIMIT,
  PRAGMA_OMP_CLAUSE_THREADS,
  PRAGMA_OMP_CLAUSE_TICK,
  PRAGMA_OMP_CLAUSE_TO,
  PRAGMA_OMP_CLAUSE_UNIFORM,
  PRAGMA_OMP_CLAUSE_UNTIED,
  PRAGMA_OMP_CLAUSE_USE_DEVICE_PTR,

  // Clauses for OpenStream FPGA extension
  PRAGMA_OMP_CLAUSE_ACCEL_NAME,
  PRAGMA_OMP_CLAUSE_ARGS,
  PRAGMA_OMP_CLAUSE_DIMENSIONS,
  PRAGMA_OMP_CLAUSE_WORK_OFFSET,
  PRAGMA_OMP_CLAUSE_WORK_SIZE,
