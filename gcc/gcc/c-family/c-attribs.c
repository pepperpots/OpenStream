...
const struct attribute_spec c_common_attribute_table[] =
{
  ...
  { "stream",                 0, 0, true, false, false, false,
			      handle_stream_attribute, NULL },
  { "stream_ref",             0, 0, true, false, false, false,
			      handle_stream_ref_attribute, NULL },
...
set_stream_type (tree decl, bool is_reference)
{
  ...
  SET_DECL_ALIGN (decl, TYPE_ALIGN (new_type));
}
