...
#define OMP_CLAUSE_FPGA_ACCEL_NAME(NODE)					\
	OMP_CLAUSE_OPERAND (OMP_CLAUSE_SUBCODE_CHECK (NODE,		\
						      OMP_CLAUSE_ACCEL_NAME), 0)
#define OMP_CLAUSE_FPGA_ARGS(NODE)					\
	OMP_CLAUSE_OPERAND (OMP_CLAUSE_SUBCODE_CHECK (NODE,		\
						      OMP_CLAUSE_ARGS), 0)
#define OMP_CLAUSE_FPGA_DIMENSIONS(NODE)						\
	OMP_CLAUSE_OPERAND (OMP_CLAUSE_SUBCODE_CHECK (NODE,		\
						      OMP_CLAUSE_DIMENSIONS), 0)
#define OMP_CLAUSE_FPGA_WORK_OFFSET(NODE)				\
	OMP_CLAUSE_OPERAND (OMP_CLAUSE_SUBCODE_CHECK (NODE,		\
						      OMP_CLAUSE_WORK_OFFSET), 0)
#define OMP_CLAUSE_FPGA_WORK_SIZE(NODE)				\
	OMP_CLAUSE_OPERAND (OMP_CLAUSE_SUBCODE_CHECK (NODE,		\
						      OMP_CLAUSE_WORK_SIZE), 0)
