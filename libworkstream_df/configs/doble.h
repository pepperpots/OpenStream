...
/* #define WS_PAPI_UNCORE_COMPONENT "perf_event_uncore" */
  ...
  #define WS_PAPI_EVENTS { "CPU_IO_REQUESTS_TO_MEMORY_IO:LOCAL_CPU_TO_REMOTE_MEM", "CPU_IO_REQUESTS_TO_MEMORY_IO:LOCAL_CPU_TO_LOCAL_MEM", "READ_REQUEST_TO_L3_CACHE:ALL", "L3_CACHE_MISSES:ALL" }
  #define WS_PAPI_UNCORE 1
  #define WS_PAPI_UNCORE_MASK { 0x0101010101010101, 0x0101010101010101, 0x0101010101010101 , 0x0101010101010101 }
  #define WS_PAPI_UNCORE_COMPONENT "perf_event_uncore"
#endif
