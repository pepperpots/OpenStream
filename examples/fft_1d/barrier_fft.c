 ...
 */
static inline void
compute_w_coefficients (int n, int a, int b, COMPLEX * W)
{
...
static inline void
fft_twiddle_gen1 (COMPLEX * in, COMPLEX * out,
...
static inline void
fft_base_2 (COMPLEX * in, COMPLEX * out)
{
  REAL r1_0, i1_0;
  REAL r1_1, i1_1;
  r1_0 = c_re(in[0]);
...
static inline void
fft_twiddle_2 (int a, int b, COMPLEX * in, COMPLEX * out,
...
static inline void
fft_unshuffle_2 (int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
  int i;
  const COMPLEX *ip;
  COMPLEX *jp;
...
static void
fft_base_4 (COMPLEX * in, COMPLEX * out)
{
  REAL r1_0, i1_0;
  REAL r1_1, i1_1;
  REAL r1_2, i1_2;
...
static void
fft_twiddle_4 (int a, int b, COMPLEX * in, COMPLEX * out,
	       COMPLEX * W, int nW, int nWdn, int m)
{
  int l1, i;
  COMPLEX *jp, *kp;
...
static inline void
fft_unshuffle_4 (int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
  int i;
  const COMPLEX *ip;
  COMPLEX *jp;
...
static void
fft_base_8 (COMPLEX * in, COMPLEX * out)
{
  REAL tmpr, tmpi;
  {
    REAL r1_0, i1_0;
...
static void
fft_twiddle_8 (int a, int b, COMPLEX * in, COMPLEX * out,
	       COMPLEX * W, int nW, int nWdn, int m)
{
  int l1, i;
  COMPLEX *jp, *kp;
...
static inline void
fft_unshuffle_8 (int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
  int i;
  const COMPLEX *ip;
  COMPLEX *jp;
...
static void
fft_base_16 (COMPLEX * in, COMPLEX * out)
{
  REAL tmpr, tmpi;
  {
    REAL r1_0, i1_0;
...
static void
fft_twiddle_16 (int a, int b, COMPLEX * in, COMPLEX * out,
		COMPLEX * W, int nW, int nWdn, int m)
{
  int l1, i;
  COMPLEX *jp, *kp;
...
static void
fft_unshuffle_16 (int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
  int i;
  const COMPLEX *ip;
  COMPLEX *jp;
...
static void
fft_base_32 (COMPLEX * in, COMPLEX * out)
{
  REAL tmpr, tmpi;
  {
    REAL r1_0, i1_0;
...
static void
fft_twiddle_32 (int a, int b, COMPLEX * in, COMPLEX * out,
		COMPLEX * W, int nW, int nWdn, int m)
{
  int l1, i;
  COMPLEX *jp, *kp;
...
static void
fft_unshuffle_32 (int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
  int i;
  const COMPLEX *ip;
  COMPLEX *jp;
 ...
 */
static void
fft_aux (int n, COMPLEX * in, COMPLEX * out, int *factors,
	 COMPLEX * W, int nW)
{
  int r, m;
  int k;
 ...
 */
void
stream_fft (int n, COMPLEX * in, COMPLEX * out)
{
  int *factors = (int *) malloc (40 * sizeof (int));		/* allows FFTs up to at least 3^40 */
  int *p = factors;
  int l = n;
  int r;
  COMPLEX *W;
 ...
 */
void
test_fft_elem (int n, int j, COMPLEX * in, COMPLEX * out)
{
  int i;
  COMPLEX sum;
  COMPLEX w;
...
void
test_fft (int n, COMPLEX * in, COMPLEX * out)
{
  int j;
...
#pragma omp task firstprivate (n, in1, out1, in2, out2)
  {
    for (n = 2; n < MAX; n*=2) {
...
test_speed (long size)
{
  ...
  for (i = 0; i < size; ++i) {
    c_re(in[i]) = (i % 5) ? 1.0 : 0.0;
    c_im(in[i]) = (i % 7) ? 0.0 : 1.0;
  }

#pragma omp task firstprivate (size, in, out, start, end)
  {
    gettimeofday (start, NULL);

    stream_fft (size, in, out);
