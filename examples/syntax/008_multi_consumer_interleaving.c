/* Similarly to producers, consumers interleave their stream accesses.
   Here, two consumers read data on stream X.  Note that they consume
   the same amount of data as what the producer sends, as long as the
   number of iterations of the loop is a multiple of 4.  */
